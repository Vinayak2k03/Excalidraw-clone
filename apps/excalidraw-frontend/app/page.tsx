...
function App() {
  return (
    <div className="min-h-screen bg-background">
      <h1 className="ml-2 mt-2 text-lg font-bold tracking-tight sm:text-3xl text-foreground">DoodleX</h1>
        ...
        <div className="container mx-auto px-4 py-16 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <div className="mt-10 flex items-center justify-center gap-x-6">
              <Link href={"/signin"}>
                <Button variant={"primary"} size="lg" className="h-12 px-6 text-primary-foreground">
                  Sign in
          ...
          <div className="bg-primary rounded-3xl p-8 sm:p-16">
            <div className="mx-auto max-w-2xl text-center">
              ...
              <div className="mx-auto mt-6 max-w-xl text-lg text-primary-foreground/80">
                <p>Join thousands of users who are already creating amazing diagrams and sketches.</p>
              </div>
              <div className="mt-10 flex items-center justify-center gap-x-6">
                <Button size="lg" variant="secondary" className="h-12 px-6 hover:bg-primary-foreground hover:text-primary">
                  Open Canvas
                  <Pencil className="ml-2 h-4 w-4" />
                </Button>
                <Button
